...
export const mockCars: Car[] = [
  ...
  },
  {
    ...
    availability: true,
    description: 'Iconic Italian supercar delivering thrilling performance and timeless design.',
    features: ['Sport Seats', 'Carbon Ceramic Brakes', 'Premium Sound', 'Sport Exhaust', 'Launch Control'],
    year: 2023,
    fuel: 'Gasoline',
    transmission: 'Manual',
    seats: 2,
